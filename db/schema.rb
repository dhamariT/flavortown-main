...
ActiveRecord::Schema[8.1].define(version: 2025_11_01_060323) do
  ...
  create_table "projects", force: :cascade do |t|
    t.decimal "ai_categorization_confidence", precision: 5, scale: 4
    t.text "ai_categorization_reasoning"
    t.datetime "ai_categorized_at"
    ...
    t.datetime "updated_at", null: false
    t.index ["ai_categorized_at"], name: "index_projects_on_ai_categorized_at"
    t.index ["certification_type"], name: "index_projects_on_certification_type"
  end
